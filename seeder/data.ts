export const rooms = [
  {
    ...
    address: "Vainguinim Beach, Panaji, Goa 403004",
    guestCapacity: 1,
    numOfBeds: 1,
    isInternet: true,
    isBreakfast: true,
  ...
  {
    name: "Hard Rock Hotel Goa w/Private Hot Tub",
    pricePerNight: 2000,
    description:
    ...
    address:
      "370/14, Bishop Alex Dias Rd, Porba Vaddo, Bardez, Calangute, Saligao, Goa",
    guestCapacity: 2,
    numOfBeds: 2,
    isInternet: true,
    isBreakfast: false,
  ...
  {
    name: "Regent Hotel Taj Neighborhood.",
    pricePerNight: 1900,
    description:
    ...
    address:
      "The Taj Mahal Palace Hotel, 8, Best Road Behind, Off, Colaba, Mumbai, Maharashtra",
    guestCapacity: 6,
    numOfBeds: 3,
    isInternet: true,
    isBreakfast: true,
  ...
  {
    name: "The Golden Palms Hotel & Spa Bangalore",
    pricePerNight: 1000,
    description:
      "Our largest room with a queen bed and foldable sofa. Comfortably fits 2-3 adults, four adults maximum. Decorated with Irish-themed colors and arts. It has a private bathroom with a shower, equipped with smart TV, mini-fridge, desk, chairs. Enjoy City views at the sitting area by the window. Located on the 3rd floor with no elevator.",
    address:
  ...
  {
    name: "The Oterra Hotel",
    pricePerNight: 4000,
    description:
      "Our largest room with a queen bed and foldable sofa. Comfortably fits 2-3 adults, four adults maximum. Decorated with Irish-themed colors and arts. It has a private bathroom with a shower, equipped with smart TV, mini-fridge, desk, chairs. Enjoy City views at the sitting area by the window. Located on the 3rd floor with no elevator.",
    address:
      "43, Velankani Tech Park, Hosur Rd, Electronics City Phase 1, Electronic City, Bengaluru, Karnataka 5601005",
    guestCapacity: 2,
    numOfBeds: 2,
    isInternet: true,
    isBreakfast: true,
  ...
  },
  {
    ...
    description:
      "Our largest room with a queen bed and foldable sofa. Comfortably fits 2-3 adults, four adults maximum. Decorated with Irish-themed colors and arts. It has a private bathroom with a shower, equipped with smart TV, mini-fridge, desk, chairs. Enjoy City views at the sitting area by the window. Located on the 3rd floor with no elevator.",
    address:
      "19/B, Metgutad, Panchgani - Mahabaleshwar Rd, Mahabaleshwar, Maharashtra 412806",
    guestCapacity: 5,
    numOfBeds: 3,
    isInternet: true,
    isBreakfast: true,
  ...
  {
    name: "Treat Resort Silvassa",
    pricePerNight: 4500,
    description:
      "Our largest room with a queen bed and foldable sofa. Comfortably fits 2-3 adults, four adults maximum. Decorated with Irish-themed colors and arts. It has a private bathroom with a shower, equipped with smart TV, mini-fridge, desk, chairs. Enjoy City views at the sitting area by the window. Located on the 3rd floor with no elevator.",
    address:
      "Treat Resort, Sayli Road, Silvassa, Dadra and Nagar Haveli and Daman and Diu 396230",
    guestCapacity: 2,
    numOfBeds: 1,
    isInternet: true,
    isBreakfast: false,
